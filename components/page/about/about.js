...
aboutTemplate.innerHTML=header.link+`
	...
	<div class="container about-container">
		<div class="row about-row">
			<h3 class="mb-4 about-head">Who We Are ? </h3>
			<hr class="mt-2"/>
		</div>
		<div class="row">
			<p class="about-p mt-4">
				&nbsp&nbsp&nbsp&nbsp What is Lorem Ipsum?
...
window.customElements.define('about-c', About);